...
class halamanController extends Controller
{
    ...
    public function store(Request $request)
    {
        ...
        return redirect()->route('halaman.index')->with('success', 'Berhasil menambahkan berita');
    }
    ...
    public function update(Request $request, $id)
    {
        ...
        return redirect()->route('halaman.index')->with('success', 'Berhasil melakukan update Berita');
    }
    ...
    public function destroy($id)
    {
        ...
        return redirect()->route('halaman.index')->with('success', 'Berhasil hapus berita');
    }
}
